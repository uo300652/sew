...
class Ciudad {
    ...
    #urlBase  = "https://archive-api.open-meteo.com/v1/archive";
    ...
    #insertarMeteorologia() {
        ...
        $("<h3>").text("Meteorología el día de la carrera").appendTo($seccion);
    ...
    #insertarEntrenos() {
        ...
        const $seccion = $("<section>").appendTo(main);
        $("<h3>").text("Meteorología entrenamientos (medias diarias)").appendTo($seccion);
