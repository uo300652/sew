...
def main():
    ...
    # Ejes
    svg.addLine(sx(min_x), sy(min_y), sx(max_x), sy(min_y), stroke="black", strokeWith="2")  # X
    svg.addLine(sx(min_x), sy(min_y), sx(min_x), sy(max_y), stroke="black", strokeWith="2")  # Y

    # Leyendas e indicadores
