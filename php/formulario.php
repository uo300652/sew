...
<form action="#" method="post">
    ...
    <p>
        <select name="dispositivo_electronico">
            <option value="">-- Selecciona --</option>
            <option value="ordenador" <?php if(isset($_POST["dispositivo_electronico"]) && $_POST["dispositivo_electronico"]=="ordenador") echo "selected"; ?>>Ordenador</option>
            <option value="tablet"     <?php if(isset($_POST["dispositivo_electronico"]) && $_POST["dispositivo_electronico"]=="tablet") echo "selected"; ?>>Tablet</option>
            <option value="telefono"   <?php if(isset($_POST["dispositivo_electronico"]) && $_POST["dispositivo_electronico"]=="telefono") echo "selected"; ?>>Teléfono</option>
        </select>
