...
<head>
    ...
    incluyendo reinicio, creación, borrado y exportación de tablas y datos de usuario.">
    <meta name="keywords" content="MotoGP, panel administración, base de datos, gestionar tablas, 
    reiniciar DB, borrar DB, crear DB, exportar CSV, usuario, tests, administración web">
